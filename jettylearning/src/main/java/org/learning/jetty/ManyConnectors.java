...
/*
 * Example of adding Connector for HTTP and other other with HTTPS protocol
 * since HTTP and HTTPS are similar you can notice that HTTPS config is cloned from HTTP and customized
 */
public class ManyConnectors {
	...
	public static void main( String[] args ) throws Exception
    {
        ...
        String jettyDistKeystore = "../../.ssh/keystore";
